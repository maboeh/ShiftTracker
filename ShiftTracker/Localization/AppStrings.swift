...
struct AppStrings {
    ...
    static let schichtTyp = "Schichttyp"
    ...
    static let kalender = "Kalender"
    static let schichten = "Schichten"
    static let ansicht = "Ansicht"
    static let wocheAnsicht = "Woche"
    static let geplanteSchicht = "Geplante Schicht"
    static let geplanteSchichten = "Geplante Schichten"
    static let erfassteSchichten = "Erfasste Schichten"
    static let neueGeplanteSchicht = "Neue geplante Schicht"
    static let geplanteSchichtBearbeiten = "Geplante Schicht bearbeiten"
    static let schicht = "Schicht"
    static let endzeit = "Endzeit"
    static let datum = "Datum"
    static let notizen = "Notizen"
    static let abbrechen = "Abbrechen"
    static let jetztStarten = "Jetzt starten"
    static let geplant = "Geplant"
    static let erfasst = "Erfasst"
    static let keineEintraege = "Keine Einträge"
    static let keineSchichtenAnTag = "Keine Schichten an diesem Tag"

    // MARK: - Shift Patterns
    static let schichtMuster = "Schichtmuster"
    static let neuesMuster = "Neues Muster"
    static let musterBearbeiten = "Muster bearbeiten"
    static let musterName = "Mustername"
    static let zyklusLaenge = "Zykluslänge"
    static let tageImZyklus = "Tage im Zyklus"
    static let tagImZyklus = "Tag %d"
    static let freiTag = "Frei"
    static let arbeitstag = "Arbeitstag"
    static let tagHinzufuegen = "Tag hinzufügen"
    static let generieren = "Generieren"
    static let wochenVoraus = "Wochen voraus"
    static let musterErweitern = "Muster erweitern"
    static let startDatum = "Startdatum"
    static let zukunftLoeschen = "Zukünftige Einträge löschen"

    // MARK: - Auto-Start & Reminders
    static let autoStart = "Auto-Start"
    static let autoStartInfo = "Schicht automatisch starten wenn die geplante Zeit erreicht ist"
    static let erinnerungVorSchicht = "Erinnerung vor Schicht"
    static let minVorher15 = "15 Min. vorher"
    static let minVorher30 = "30 Min. vorher"
    static let minVorher60 = "60 Min. vorher"
    static let keineErinnerung = "Keine"
    static let geplanteSchichtErinnerungTitel = "Schicht beginnt bald"
    static let geplanteSchichtErinnerungText = "Deine %@ beginnt in %d Minuten."
    static let musterBeschreibung = "Erstelle ein Schichtmuster für wiederkehrende Arbeitsrhythmen"
    static let aktiv = "Aktiv"
    static let inaktiv = "Inaktiv"
    static let tageZyklus = "Tage-Zyklus"
    static let schichtplanung = "Schichtplanung"
    static let erinnerungenFuerGeplanteSchichten = "Erinnerungen für geplante Schichten"
    static let standardErinnerungszeit = "Standard-Erinnerungszeit"
}
